...
class TestCheckCanaryGate:
    ...
    def test_passes_with_good_metrics(self, mock_error: object, mock_latency: object) -> None:
    ...
    @patch("src.core.orchestration.tasks.canary_gate.query_p99_latency")
    @patch("src.core.orchestration.tasks.canary_gate.query_error_rate")
    def test_fails_on_absolute_error_rate(self, mock_error: object, mock_latency: object) -> None:
    ...
    @patch("src.core.orchestration.tasks.canary_gate.query_p99_latency")
    @patch("src.core.orchestration.tasks.canary_gate.query_error_rate")
    def test_fails_on_high_error_ratio(self, mock_error: object, mock_latency: object) -> None:
    ...
    @patch("src.core.orchestration.tasks.canary_gate.query_p99_latency")
    @patch("src.core.orchestration.tasks.canary_gate.query_error_rate")
    def test_fails_on_high_latency_ratio(self, mock_error: object, mock_latency: object) -> None:
    ...
    @patch("src.core.orchestration.tasks.canary_gate.query_p99_latency")
    @patch("src.core.orchestration.tasks.canary_gate.query_error_rate")
    def test_passes_when_canary_data_insufficient(self, mock_error: object, mock_latency: object) -> None:
    ...
    @patch("src.core.orchestration.tasks.canary_gate.query_p99_latency")
    @patch("src.core.orchestration.tasks.canary_gate.query_error_rate")
    def test_passes_when_champion_error_is_zero(self, mock_error: object, mock_latency: object) -> None:
